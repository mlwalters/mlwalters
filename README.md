...
- [MEAN stack app (May 21, 2021 - Present)](https://github.com/mlwalters/MEANStackWebApp) Building a full-stack social media app using Angular, Node.js, Express, and MongoDB (MEAN stack). Features include authentication and authoriimage upload, pagination
